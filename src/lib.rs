...
The constructors that actually will be generated also have an internal lifetime for
nesting purposes. Therefore, they will look like this:
...
with writing these constructors.
...
Mmio${InnerField}::new_mmio constructor, so you have to provide this constructor yourself
if the constructor generation is disabled.
